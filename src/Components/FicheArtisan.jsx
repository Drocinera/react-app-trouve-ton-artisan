      ...
      <div className="colorTest">
        <div className="cardStyle row py-3 ">
          <div className="card col border border-dark" style={{width: '18rem'}}>
            <div className="cardColor card-body  text-center">
              ...
              <a className="card-text" href="{artisan.website}">{artisan.website}</a>
            </div>
        </div>
      </div>
        <h2 className="ficheArtisanTitle text-dark py-2 mx-4 text-center ">Une demande ? Remplissez le formulaire pour contacter l'artisan !</h2>
          <div className="colorTest2">
            <form class="row g-3 needs-validation px-4" novalidate>
              <div class="row g-3">
                <div class="col mb-3">
                  <label for="inputFirstName" class="col-sm-2 col-form-label">Nom :</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" placeholder="Nom" aria-label="First name" required/>
                  </div>
                </div>
                <div class="col mb-3">
                  <label for="inputLastName" class="col-sm-2 col-form-label">Prénom :</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" placeholder="Prénom" aria-label="Last name" required/>
                  </div>
                </div>
              </div>
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <input type="email" class="form-control" id="inputEmail3" placeholder="exemple@exemple.com" required/>
                </div>
              </div>
              <div class="row mb-3">
                <label for="inputSujet" class="col-sm-2 col-form-label">Sujet du message:</label>
                <div class="col-sm-10">
                  <input type="password" class="form-control" id="inputSujet" placeholder="Objet de votre message" required/>
                </div>
              </div>
              <div class="mb-3">
                <label for="formControlTextarea1" class="form-label">Message :</label>
                <textarea class="form-control" id="formControlTextarea1" rows="3" placeholder="Entrez votre message ici" required/>
              </div>
              <div class="row mb-3">
...
//Ajouter systeme verification boostrap pour formulaire et ameliorer estétique